...
const Community = () => {
    ...
    let filtered = posts.filter((post) => {
      ...
      if (searchTerm) {
        ...
        return (
          ...
          post.profiles?.username?.toLowerCase().includes(lower)
        );
      }
      return true;
    });
  ...
  const getUserDisplayName = (post: Post) => post.profiles?.username || "Usuário Anônimo";
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <Card className="mb-12 border-primary/20">
          <CardHeader>
            ...
            <CardDescription>
              {user ? "Descreva o filme que você está procurando." : "Faça login para publicar uma pergunta."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
            ...
            <Button
              ...
              className="w-full gold-glow rounded-xl font-semibold tracking-wide"
              ...
              return (
                <Card key={post.id} className="glass-card border-gradient card-hover overflow-hidden group">
                  ...
                  <CardContent className="pt-0">
                    <p className="text-foreground/90 leading-relaxed mb-4 text-[15px]">{post.description}</p>
            ...
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground/70">
                {searchTerm || statusFilter !== "all"
                  ...
                  : "Seja o primeiro a postar uma pergunta!"}
              </p>
            </div>
          )}
        </div>
